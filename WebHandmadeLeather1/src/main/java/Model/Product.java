...
public class Product {
	...
	public Product(String productID, String productName, String productType, double productPrice, String productImg,
			boolean isTrend, boolean isPopular, boolean isSaleoff) {
		super();
